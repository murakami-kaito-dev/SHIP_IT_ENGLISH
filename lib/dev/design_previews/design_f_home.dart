...
/// 【デザインプレビュー・案F「ソフトアーケード」】
///
/// フィードバックで「絶妙」と評された案Bのバランス（白背景・細線＋下エッジ・
/// ほどよい丸み・意味別カラー）だけを移植し、外皮を自社DNA（藍・mono数字・
/// >_ロゴ）に置き換えた静的モック。パクリ感なくBの快適さを得る。
class DesignFHome extends StatelessWidget {
  const DesignFHome({super.key});

  // --- 案Fのデザイントークン ---
  static const bg = Color(0xFFF7F7FC);
  static const ink = Color(0xFF2A2C3E);
  static const subText = Color(0xFF5D6178);
  static const line = Color(0xFFE3E4F0);
  ...
  static const goldSoft = Color(0xFFFFF1C9);
  static const teal = Color(0xFF17B890);
  static const tealSoft = Color(0xFFD7F5EA);
  static const blue = Color(0xFF2E9BE8);
  static const blueSoft = Color(0xFFDBEDFF);
  ...
  /// 細線1.5px＋下エッジ（solid shadow）のカード。
  /// Bの「下辺だけ厚い枠」の手応えを、角丸と両立する影で再現する。
  Widget _card({required Widget child}) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: const [
          BoxShadow(color: line, offset: Offset(0, 3)),
        ],
      ),
      child: child,
    );
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: line, width: 1.5),
            boxShadow: const [
              BoxShadow(color: line, offset: Offset(0, 2.5)),
            ],
          ),
          child: const Icon(Icons.emoji_events_rounded, size: 18, color: gold),
        ),
        const SizedBox(width: 10),
    ...
    return Expanded(
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: selected ? indigoChipEdge : line,
  ...
  Widget _statRow(String emoji, String label, String value,
      {bool dimmed = false}) {
    final color = dimmed ? const Color(0xFFAEB2C6) : ink;
    return Row(
      children: [
        ...
        Text(label,
            style: TextStyle(
                fontSize: 13,
                fontWeight: FontWeight.w600,
                color: dimmed ? const Color(0xFFAEB2C6) : subText)),
        const Spacer(),
        Text(value,
            style: TextStyle(
                fontFamily: 'Menlo',
    ...
    return _card(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          _questRow(goldSoft, '🃏', 'カードを20枚学習する', '0/20', gold, 0.06),
          const SizedBox(height: 10),
          _questRow(tealSoft, '✅', '「覚えてた」を6回出す', '0/6', teal, 0.05),
          const SizedBox(height: 10),
          _questRow(blueSoft, '⚡', '5コンボを達成する', '0/5', blue, 0.05),
      ...
      child: Column(
        ...
        children: [
          ...
          const Text('あと 9 XP で LV 4！',
              style: TextStyle(
                  fontSize: 12, fontWeight: FontWeight.w800, color: teal)),
        ],
      ),
    );
  }
  ...
  Widget _navItem(IconData icon, String label, {required bool active}) {
    final color = active ? indigo : const Color(0xFFA2A6BC);
    return Expanded(
      child: Column(
